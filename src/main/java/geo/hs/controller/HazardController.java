...
public class HazardController {
    ...
    private static HazardRepository hazardRepository = new HazardRepository();

    @GetMapping("/bridge")
    public ArrayList<Hazard> bridge(Model model) throws SQLException {
        ArrayList<Hazard> hazards = hazardRepository.getBridge();
        return hazards;
    }

    @GetMapping("/tunnel")
    public ArrayList<Hazard> tunnel(Model model) throws SQLException {
        ArrayList<Hazard> hazards = hazardRepository.getTunnel();
        return hazards;
    }
}
